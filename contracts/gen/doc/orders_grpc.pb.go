...
func (c *ordersStreamServiceClient) OrderStateStream(ctx context.Context, in *OrderStateStreamRequest, opts ...grpc.CallOption) (OrdersStreamService_OrderStateStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &OrdersStreamService_ServiceDesc.Streams[1], "/tinkoff.public.invest.api.contract.v1.OrdersStreamService/OrderStateStream", opts...)
	if err != nil {
		return nil, err
	}
...
// All implementations should embed UnimplementedOrdersStreamServiceServer
...
// UnimplementedOrdersStreamServiceServer should be embedded to have forward compatible implementations.
...
func (c *ordersServiceClient) PostOrderAsync(ctx context.Context, in *PostOrderAsyncRequest, opts ...grpc.CallOption) (*PostOrderAsyncResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tinkoff.public.invest.api.contract.v1.OrdersService/PostOrderAsync", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ordersServiceClient) GetMaxLots(ctx context.Context, in *GetMaxLotsRequest, opts ...grpc.CallOption) (*GetMaxLotsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tinkoff.public.invest.api.contract.v1.OrdersService/GetMaxLots", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ordersServiceClient) GetOrderPrice(ctx context.Context, in *GetOrderPriceRequest, opts ...grpc.CallOption) (*GetOrderPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tinkoff.public.invest.api.contract.v1.OrdersService/GetOrderPrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OrdersService_PostOrderAsync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tinkoff.public.invest.api.contract.v1.OrdersService/PostOrderAsync",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OrdersService_GetMaxLots_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tinkoff.public.invest.api.contract.v1.OrdersService/GetMaxLots",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OrdersService_GetOrderPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tinkoff.public.invest.api.contract.v1.OrdersService/GetOrderPrice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
