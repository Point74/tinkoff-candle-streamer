...
func (c *sandboxServiceClient) PostSandboxOrderAsync(ctx context.Context, in *PostOrderAsyncRequest, opts ...grpc.CallOption) (*PostOrderAsyncResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tinkoff.public.invest.api.contract.v1.SandboxService/PostSandboxOrderAsync", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sandboxServiceClient) GetSandboxMaxLots(ctx context.Context, in *GetMaxLotsRequest, opts ...grpc.CallOption) (*GetMaxLotsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tinkoff.public.invest.api.contract.v1.SandboxService/GetSandboxMaxLots", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SandboxService_PostSandboxOrderAsync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tinkoff.public.invest.api.contract.v1.SandboxService/PostSandboxOrderAsync",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SandboxService_GetSandboxMaxLots_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tinkoff.public.invest.api.contract.v1.SandboxService/GetSandboxMaxLots",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
