...
// All implementations should embed UnimplementedStopOrdersServiceServer
...
// UnimplementedStopOrdersServiceServer should be embedded to have forward compatible implementations.
