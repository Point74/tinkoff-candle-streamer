...
func (c *marketDataServiceClient) GetTechAnalysis(ctx context.Context, in *GetTechAnalysisRequest, opts ...grpc.CallOption) (*GetTechAnalysisResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tinkoff.public.invest.api.contract.v1.MarketDataService/GetTechAnalysis", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MarketDataService_GetTechAnalysis_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tinkoff.public.invest.api.contract.v1.MarketDataService/GetTechAnalysis",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
// All implementations should embed UnimplementedMarketDataStreamServiceServer
// for forward compatibility
...
// UnimplementedMarketDataStreamServiceServer should be embedded to have forward compatible implementations.
